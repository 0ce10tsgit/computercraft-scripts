# deploy-relay.ps1
# Copies relay.lua to each relay computer's startup folder, then uploads via SFTP.
# Reads host/credentials from ../.vscode/sftp.json so nothing is hardcoded here.
...
Write-Host ""
Write-Host "Done. Reboot computers 1, 2, and 3 in-game to apply."
